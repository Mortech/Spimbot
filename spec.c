/*
  ...
  Spimbot specs people should know.
  ...
  or stored away in funtions. They are saved for use as defined here:

  $s5: the head of the token list
  $s6: the tail of the token list 

	$t8 and $t10: used in sort_list, should be restored if interrupted
	$t9: constant value - 1

  more to come use on code you need to run a lot.
